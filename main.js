    ...
    let showAllButton = document.querySelector("#tasks-all-check");
    let showNotCompletedButton = document.querySelector("#tasks-incomplete-check");
    ...
    // //***********1st option********//// filter + forEach method
